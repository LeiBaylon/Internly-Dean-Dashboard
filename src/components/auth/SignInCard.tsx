  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#121417] px-5 py-8 text-ink">
      ...
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-2xl border border-stroke bg-[#17191e]/95 shadow-[0_30px_90px_rgba(0,0,0,0.35)] lg:grid-cols-[0.9fr_1fr]">
        <section className="relative min-h-[360px] overflow-hidden border-b border-stroke bg-[#15171b] p-8 sm:p-10 lg:min-h-[500px] lg:border-b-0 lg:border-r">
          ...
          <div className="relative flex h-full flex-col justify-between">
            <div>
              <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-[#35e0ad] to-[#08a978] text-2xl font-bold text-white shadow-soft">
                I
              </div>
        ...
        <section className="flex min-h-[360px] items-center bg-[#17191e] p-8 sm:p-10 lg:min-h-[500px]">
